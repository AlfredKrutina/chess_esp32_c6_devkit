...
| **Firmware v tomto repu** | **`1.8.0`** — co reálně běží na prototypu (viz `CMakeLists.txt` → `PROJECT_VERSION`) | Stejný softwarový ekosystém (OTA z aplikace, API); úpravy pro Hall / STM32 segment podle integrace |
