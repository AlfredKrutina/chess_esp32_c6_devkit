...
| 4A.3 | `js/prefs.js` | devicePrefs, hint getters, UI settings sync | **hotovo** (PR #7) |
| 4A.4 | `js/board.js`, `js/bot.js` | board UI, Stockfish/bot | plán |
...
- [OPENING_TRAINING_PLAN.md](OPENING_TRAINING_PLAN.md) — návrh interaktivního tréninku zahájení (paralelní feature, po cleanup Fáze 3–4)
